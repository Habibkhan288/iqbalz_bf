...
logo = """\033[1;91m     ___    _____  ___    _   _  ___    _   _  _____  _   _ 
  ...
  _    _          ____ _____ ____  _  ___    _          _   _ 
 | |  | |   /\   |  _ \_   _|  _ \| |/ / |  | |   /\   | \ | |
 | |__| |  /  \  | |_) || | | |_) | ' /| |__| |  /  \  |  \| |
 |  __  | / /\ \ |  _ < | | |  _ <|  < |  __  | / /\ \ | . ` |
 | |  | |/ ____ \| |_) || |_| |_) | . \| |  | |/ ____ \| |\  |
 |_|  |_/_/    \_\____/_____|____/|_|\_\_|  |_/_/    \_\_| \_|
...
def super():
	...
	print "\033[1;97m3.\x1b[1;92mClone From Group ID"
...
def pilih_super():
	...
	if peak =="":
		...
		print logo2
		print logo3
		grp = raw_input('Enter Group ID:- ')
		try:
			grp = requests.get('https://graph.facebook.com/group/?id=' + id + '&access_token=' + toket)
			grps = json.loads(r.text)
			print "'\033[1;93mName\033[1;93m:-\033[1;97m "+grps["name"]
		except KeyError:
			print('\x1b[1;92mGroup Not Found!')
			raw_input("\n\033[1;92m[\033[1;91mBack\033[1;92m]")
			super()
		print"\033[1;93mGetting IDs\033[1;92m..."
